...
<Callout type="warn" title="Use official artifacts">
  Do not install update files forwarded through chat or uploaded to an unrelated repository. Use the Clawd Bot releases repository and its checksums.
</Callout>
