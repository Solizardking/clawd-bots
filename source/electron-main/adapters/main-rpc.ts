...
function createExistingMainRpcCoreDeps(
  ...
  const solana = requireObject(
    (supplied.solana === undefined ? context.solana : supplied.solana) as object | null | undefined,
    "mainRpc.solana",
  ) as MainEdgeWiringDeps["solana"];
  const telegram = requireObject(
    (supplied.telegram === undefined ? context.telegram : supplied.telegram) as object | null | undefined,
    "mainRpc.telegram",
  ) as MainEdgeWiringDeps["telegram"];
