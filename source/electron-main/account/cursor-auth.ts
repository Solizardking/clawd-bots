...
export class SandAuthSignInRequiredError extends Error { constructor() { super("Sign in to Cursor to run Clawd Bot."); } }
export class SandAuthSignInExpiredError extends Error { constructor() { super("Cursor sign-in expired. Sign in again to run Clawd Bot."); } }
...
const RETAINED_AFTER_FAILED_LOGOUT_STATUS = { kind: "logged-out", errorMessage: "Clawd Bot couldn't remove the saved Cursor sign-in. The account may return after Clawd Bot restarts. Sign in to try again." } as const;
const LOGGED_OUT_STATUS = { kind: "logged-out" } as const;
const SIGN_IN_CONFIRMATION_FAILED_STATUS = { kind: "logged-out", errorMessage: "Clawd Bot couldn't confirm your Cursor sign-in. Restart Clawd Bot or sign in again." } as const;
const SIGN_IN_EXPIRED_STATUS = { kind: "logged-out", errorMessage: "Cursor sign-in expired. Sign in again to run Clawd Bot." } as const;
...
const ACCOUNT_REFUSED_CREDENTIALS_RETAINED_STATUS = { kind: "logged-out", errorMessage: "This computer is linked to another Cursor account. Clawd Bot couldn't remove the saved Cursor sign-in, so the account may return after restart. Sign in with the linked account to continue." } as const;
