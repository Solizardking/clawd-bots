...
final class NotificationCoordinator: NSObject, UNUserNotificationCenterDelegate {
    ...
    func deliver(_ notification: NotificationFrame, sequence: Int?) {
        ...
        content.categoryIdentifier = notification.isBlocking ? "OPENCLAWD_APPROVAL" : "OPENCLAWD_UPDATE"
        ...
        let identifier = "clawd.\(notification.threadId).\(sequence.map(String.init) ?? notification.title)"
