...
extension ClawdState {
    ...
    private static let legacy: [String: ClawdState] = [
    ...
    static func normalize(_ value: String?) -> ClawdState? {
        guard let value, !value.isEmpty else { return nil }
        return ClawdState(rawValue: value) ?? legacy[value]
    }

    static func forBot(_ bot: Bot, last: Message?) -> ClawdState {
    ...
    static func forChat(_ chat: Chat, in state: CompanionState) -> ClawdState {
        switch chat {
