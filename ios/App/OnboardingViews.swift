...
struct CompanionWelcomeView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 28) {
                ...
                ZStack {
                    RoundedRectangle(cornerRadius: 32, style: .continuous)
                        .fill(ClawdPalette.color("blue").opacity(0.12))
                        .frame(width: 148, height: 148)
                    ClawdAvatar(color: "blue", size: 108, state: .happy, animated: false)
        ...
        .background {
            LinearGradient(
                colors: [ClawdPalette.color("blue").opacity(0.10), Color.clear],
                startPoint: .top,
                endPoint: .center
            )
            .ignoresSafeArea()
    ...
    var body: some View {
        HStack(alignment: .top, spacing: 14) {
            Image(systemName: icon)
                .font(.title3)
                .foregroundStyle(ClawdPalette.color("blue"))
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 8) {
                        Text("Connect when you're ready")
                            .font(.title2.bold())
                        Text("Pair this iPhone with Clawd Bot to see your chats and respond to your bots.")
                            .foregroundStyle(.secondary)
                            .multilineTextAlignment(.center)
                            .fixedSize(horizontal: false, vertical: true)
                    }

                    Text("On your computer, open Clawd Bot → Settings → Phone.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
            ...
            VStack(spacing: 10) {
                ...
                ZStack {
                    RoundedRectangle(cornerRadius: 30, style: .continuous)
                        .fill(ClawdPalette.color("green").opacity(0.12))
                        .frame(width: 132, height: 132)
                    Image(systemName: "bell.badge.fill")
                        .font(.system(size: 48, weight: .medium))
                        .foregroundStyle(ClawdPalette.color("green"))
                }
                .accessibilityHidden(true)
                ...
                VStack(spacing: 10) {
                    Text("Stay in the loop")
                        .font(.largeTitle.bold())
                    Text("Get alerts while Clawd Bot is open or was recently in the background. Alerts stop after iOS fully suspends or closes the app.")
                        .font(.title3)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                        .fixedSize(horizontal: false, vertical: true)
