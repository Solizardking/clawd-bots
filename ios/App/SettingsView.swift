    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Alerts arrive while Clawd Bot is open or was recently in the background. Closed-app delivery is not available yet.")
            }
        ...
        HStack(spacing: 12) {
            ZStack {
                RoundedRectangle(cornerRadius: 10, style: .continuous)
                    .fill(ClawdPalette.color("blue").opacity(0.14))
...
struct ConnectionSecurityView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("This removes the connection from this iPhone only. It does not revoke this phone on your Mac. To remove Mac-side access, open Clawd Bot → Settings → Phone and remove this device.")
        }
    }
    ...
    private var troubleshootingText: String {
        ...
        case .connecting:
            return "Clawd Bot is trying the saved connection automatically."
