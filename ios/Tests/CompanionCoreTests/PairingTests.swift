...
final class PairingTests: XCTestCase {
    ...
    func testRejectsAServiceThatDoesNotIdentifyAsClawd Bot() async throws {
    ...
    private static let health = Data(#"{"app":"clawdbot","pid":42,"static":true}"#.utf8)
