...
2. Register the bundle IDs `com.clawdbot.app` and `com.clawdbot.app.widgets` (or change them in `project.yml` before the first upload).
3. Create the matching app in App Store Connect with the name **Clawd Mobile**, primary category **Productivity**, and a unique SKU.
...
- Support URL: `https://github.com/milind-soni/Clawd Bot/issues`
- Privacy policy URL: `https://github.com/milind-soni/Clawd Bot/blob/main/docs/ios-privacy.md`
