...
[clawdbot-releases](https://github.com/milind-soni/clawdbot-releases),
...
Set these in **Clawd Bot → Settings → Secrets and variables → Actions**.
...
Fine-grained tokens** → repository access: only `clawdbot-releases` →
