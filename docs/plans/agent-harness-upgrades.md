# Clawd Bot harness implementation plan
...
(pi, agent-orchestrator, deepseek-harness) and asking what Clawd Bot lacked by
...
**The reframe that reorders everything.** Clawd Bot is itself a harness. The
...
**On-disk forward compatibility.** `~/.clawdbot` is shared across app versions.
