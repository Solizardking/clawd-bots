...
const SUBJECTS = {
  "sign-in": "Your Clawd Bot sign-in code",
  "email-verification": "Verify your Clawd Bot email",
  "forget-password": "Reset your Clawd Bot password",
  "change-email": "Confirm your Clawd Bot email change",
...
export function buildOTPEmail(from: string, input: OTPEmailInput) {
  ...
  return {
    to: input.email,
    from: { email: from, name: "Clawd Bot" },
    subject,
    html,
    text,
  };
