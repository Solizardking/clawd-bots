...
export const ANTIGRAVITY_COMPUTER_MCP_KEY = "clawdbot-computer";
 ...
 * Cloud boxes go through Clawd Bot's REST-to-MCP adapter (the same spec
...
/** Upsert (server) or remove (null) the clawdbot-computer entry in the
...
export function ensureAntigravityComputerMcp(
  ...
  return () => {
    ...
    // Clawd Bot entry is preferable to destroying bytes we cannot interpret.
