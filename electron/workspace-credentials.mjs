...
export const WORKSPACE_CREDENTIALS = [
  ...
  { section: "solana", field: "heliusApiKey", name: "heliusApiKey", env: "HELIUS_API_KEY" },
  { section: "solana", field: "phantomOrganizationId", name: "phantomOrganizationId", env: "PHANTOM_ORGANIZATION_ID" },
  { section: "solana", field: "phantomAppId", name: "phantomAppId", env: "PHANTOM_APP_ID" },
  { section: "solana", field: "phantomApiPrivateKey", name: "phantomApiPrivateKey", env: "PHANTOM_API_PRIVATE_KEY" },
  { section: "solana", field: "jupiterApiKey", name: "jupiterApiKey", env: "JUPITER_API_KEY" },
];
