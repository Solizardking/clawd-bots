...
export const SKIN_IDS = ["midnight", "atelier", "foundry", "lagoon", "solana"] as const;
...
export const SKINS: readonly Skin[] = [
  ...
  { id: "solana", name: "Solana", tagline: "Purple and green, the cluster's own pair." },
];

export const DEFAULT_SKIN: SkinId = "solana";

const KEY = "clawd-skin";
