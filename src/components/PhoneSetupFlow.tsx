  ...
  if (c.phase === "intro") {
    return (
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="mt-4 text-[19px] font-semibold text-ink">Use Clawd Bot from your phone</h2>
  ...
  if (c.phase === "success") {
    return (
      <div className="flex flex-col items-center py-6 text-center">
        ...
        >
          {variant === "onboarding" ? "Start using Clawd Bot" : "Done"}
        </button>
      </div>
    );
  }
    ...
    <div className="flex flex-col items-center text-center">
      ...
      <p className="mt-1 text-[13px] text-ink-secondary">
        {c.pairingExpired
          ...
          : "Open Clawd on your iPhone and scan this code."}
      </p>
      ...
      {!c.pairingExpired && manualCodeMode === "direct" && c.state?.pairing && (
        <div className="mt-4 w-full max-w-[320px] rounded-xl bg-inset px-4 py-3 text-[12.5px] text-ink-secondary">
          <div>Open ClawdMobile and enter this manual code.</div>
