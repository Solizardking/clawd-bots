...
export function CompanionSection({ profileEmail = "" }: { profileEmail?: string }) {
  ...
  if (!companionBridge()) {
    return (
      <Card
        title="Use Clawd Bot from your phone"
        subtitle="Open Settings in the Clawd Bot desktop app to set up a phone."
      />
    );
  }
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Card
        title="Paired phones"
        subtitle={pairedCount ? "Manage the phones that can use this Clawd Bot." : "No phones are paired yet."}
      >
        {pairedCount > 0 && (
