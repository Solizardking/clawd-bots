...
const COMMUNITY_TEAMS_REPOSITORY = "https://github.com/milind-soni/clawdbot-teams";
              ...
              {tab === "import" && (
                <div>
                  <input
                    ref={fileInputRef}
                    type="file"
                    accept=".md,.json,.clawdteam.json,text/markdown,application/json"
                    className="hidden"
                    onChange={(event) => {
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    ...
                    >
                      ...
                      <span className="mt-1 text-[12.5px] text-ink-secondary">or drop a BotMRR .md / legacy team JSON here</span>
                    </button>
