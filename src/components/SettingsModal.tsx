...
import { Coins, KeyRound, Monitor, Search, Smartphone, Terminal, User, Wallet, X } from "lucide-react";
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <div className="flex flex-1 flex-col gap-4 overflow-y-auto px-5 pb-5">
            ...
            {section === "solana" && (
              <Card
                title="Solana"
                subtitle="Helius, optional Phantom, and Jupiter keys stay write-only. Local wallets are sealed; bots get public addresses only."
              >
                <SolanaSettings />
              </Card>
            )}
